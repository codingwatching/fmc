...
impl F64Transform {
    ...
    pub const IDENTITY: Self = F64Transform {
    ...
    #[inline]
    pub fn rotate_local_axis(&mut self, axis: Vec3, angle: f64) {
...
/// will be invalid.
impl From<F64GlobalTransform> for F64Transform {
    fn from(transform: F64GlobalTransform) -> Self {
        transform.compute_transform()
    }
}

impl Mul<F64Transform> for F64Transform {
    type Output = F64Transform;
...
impl Mul<Vec3> for F64Transform {
    type Output = Vec3;
