...
use bevy::prelude::*;
pub use components::{F64GlobalTransform, F64Transform};
...
pub struct TransformBundle {
    ...
    pub local: F64Transform,
    /// The global transform of the entity.
    pub global: F64GlobalTransform,
}
...
impl TransformBundle {
    ...
    pub const IDENTITY: Self = TransformBundle {
        local: F64Transform::IDENTITY,
        global: F64GlobalTransform::IDENTITY,
    };
    ...
    #[inline]
    pub const fn from_transform(transform: F64Transform) -> Self {
        TransformBundle {
            local: transform,
            ..Self::IDENTITY
        }
...
impl From<F64Transform> for TransformBundle {
    #[inline]
